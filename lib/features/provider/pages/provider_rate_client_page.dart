...
class ProviderRateClientPage extends StatefulWidget {
  const ProviderRateClientPage({
    super.key,
    required this.store,
  ...
  @override
  State<ProviderRateClientPage> createState() => _ProviderRateClientPageState();
}

class _ProviderRateClientPageState extends State<ProviderRateClientPage> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await widget.store.submitProviderRating(
      ...
      AppFeedback.showSuccess(
        context,
        'Evaluation client envoyee.',
      );

      widget.store.setProviderTab(0);
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Evaluer le client'),
        ),
        body: SafeArea(
          child: ListView(
