...
Future<void> _loadEnvironment() async {
  ...
  try {
    ...
    if (kDebugMode) {
      debugPrint('Optional .env file was not loaded: $e');
    }
  }
}
      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          ...
          inputDecorationTheme: InputDecorationTheme(
            ...
            hintStyle:
                const TextStyle(color: muted, fontWeight: FontWeight.w500),
            ...
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(18),
              borderSide:
                  const BorderSide(color: Color(0xFFE89A1E), width: 1.4),
            ),
          ...
          chipTheme: ChipThemeData(
            ...
            secondaryLabelStyle: const TextStyle(
                color: Color(0xFF1E1400), fontWeight: FontWeight.w800),
            shape: RoundedRectangleBorder(
...
class _AppEntryState extends State<_AppEntry> with WidgetsBindingObserver {
  ...
  var _authPreferenceReady = false;
  var _startupPermissionReady = false;
  var _showOnboarding = false;
  var _preferSignup = false;
  var _showPermissionGate = false;
