...
const _localizedValues = {
  AppLanguage.fr: {
    ...
    'otpSubtitle': 'Entrez le code a 6 chiffres envoye au',
    'otpSend': 'Envoyer le code OTP',
    'otpSending': 'Envoi...',
    'otpVerify': 'Verifier',
    'otpVerifying': 'Verification...',
    'otpResend': 'Renvoyer le code',
    'otpResendIn': 'Renvoyer dans {0}s',
    'otpChangeNumber': 'Changer de numero',
    'otpInvalid': 'Code OTP invalide',
    'otpExpired': 'Code expire. Veuillez renvoyer un nouveau code.',
    'phoneLabel': 'Numero de telephone',
    'phoneHint': '0550 12 34 56',
    'phoneInvalid': 'Numero de telephone invalide',
    'loginWithPassword': 'Mot de passe',
    'loginWithOtp': 'Code OTP',
    'confirmPassword': 'Confirmer le mot de passe',
    'passwordsMismatch': 'Les mots de passe ne correspondent pas',
    'providerApprovalTitle': 'Validation en attente',
    'providerApprovalMessage':
    ...
    'providerApprovalUnderstood': 'Compris',
    'providerApprovalReturn': 'Retour a la connexion',
  },
  AppLanguage.en: {
    'language': 'Language',
    ...
    'otpSend': 'Send OTP Code',
    'otpSending': 'Sending...',
    'otpVerify': 'Verify',
    'otpVerifying': 'Verifying...',
    'otpResend': 'Resend code',
    'otpResendIn': 'Resend in {0}s',
    ...
    'loginWithOtp': 'OTP Code',
    'confirmPassword': 'Confirm password',
    'passwordsMismatch': 'Passwords do not match',
    'providerApprovalTitle': 'Approval Pending',
    'providerApprovalMessage':
        'Your provider account has been created successfully. You must wait for admin approval before accessing the app.',
    'providerApprovalUnderstood': 'Understood',
    'providerApprovalReturn': 'Back to login',
  },
  AppLanguage.ar: {
    'language': 'اللغة',
    ...
    'loginWithOtp': 'رمز OTP',
    'confirmPassword': 'تأكيد كلمة المرور',
    'passwordsMismatch': 'كلمتا المرور غير متطابقتين',
    'providerApprovalTitle': 'في انتظار الموافقة',
    'providerApprovalMessage':
        'تم إنشاء حساب المزود بنجاح. يجب الانتظار حتى موافقة الإدارة قبل الوصول للتطبيق.',
    'providerApprovalUnderstood': 'فهمت',
    'providerApprovalReturn': 'العودة لتسجيل الدخول',
  },
};
